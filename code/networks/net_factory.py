...
from networks.MobileViT_seg import MobileViTSeg
import argparse
...
parser.add_argument('--exp', type=str,default='ACDC/Cross_Supervision_CNN_Trans2D', help='experiment_name')
...
def net_factory(net_type="unet", in_chns=1, class_num=3):
    if net_type == "unet":
        ...
        net = MobileViTSeg(in_chns=in_chns, class_num=class_num).cuda()
