...
class MobileBaseSeg(nn.Module):
    def __init__(self, in_chns=1,class_num=2,P1=1, P2 =2,P3=2,  aux=False):
        super(MobileBaseSeg, self).__init__()
        self.D1 = int(P1 / 2)
        print('P1 = ', P1)
        print('D1 = ', self.D1)
        self.D2 = int(P2 / 2)
        ...
        for i in range(0, self.D1):
            self.level1_long.append(MV2Block(8, 8, stride=1))
        ...
        for i in range(0, self.D2):
            self.level2_long.append(MV2Block(24, 24, stride=1))
        ...
        for i in range(0, self.D3):
            self.level3_long.append(MV2Block(32, 32, stride=1))
