...
class BaseDataSets(Dataset):
    def __init__(self,base_dir=None,split="train", num=None, transform=None,ops_weak=None,ops_strong=None, ):
        ...
        assert bool(ops_weak) == bool(ops_strong), "For using CTAugment learned policies, provide both weak and strong batch augmentation policy"
    ...
    def __getitem__(self, idx):
        ...
        #     print('没有进行transform之前！')
        #     print('key  = ', key)
        #     print('value type = ', type(value))
        #     print('value shape = ', value.shape)
        #     # if key  == 'label':
        #     #     np.savetxt('001',value)
        #     print('-'*20)
...
class TwoStreamBatchSampler(Sampler):
    ...
    def __iter__(self):
        ...
        # print('-'*100)
        # print('primary_iter type =', type(primary_iter))
        # print('secondary_iter type =', type(secondary_iter))
        # print(list(primary_iter))
        return (
