...
parser.add_argument('--exp', type=str,default='ACDC/Cross_Teaching_Between_CNN_Transformer', help='experiment_name')
parser.add_argument('--model', type=str, default='MobileViT', help='model_name')
parser.add_argument('--max_iterations', type=int,default=35000, help='maximum epoch number to train')
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            if iter_num > 0 and iter_num % 200 == 0:
                ...
                for i_batch, sampled_batch in enumerate(valloader):
                    metric_i = test_single_volume(sampled_batch["image"], sampled_batch["label"], model1, classes=num_classes, patch_size=args.patch_size)
